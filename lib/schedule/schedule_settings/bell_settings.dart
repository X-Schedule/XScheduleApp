...
class _BellSettingsState extends State<BellSettings> {
  ...
  void _startBellTutorial(BuildContext context, bool alt,
    ...
    if (alt) {
      BellSettings.bellTutorialSystem
          .set(BellSettings.bellAltTutorials);
    } else {
  ...
  Widget _buildColorSelection(BuildContext context, String bell, List<String> hexColors) {
    final ColorScheme colorScheme = Theme.of(context).colorScheme;
    final MediaQueryData mediaQuery = MediaQuery.of(context);
  ...
  Widget _buildDaySelector(
      BuildContext context, String bell) {
    final ColorScheme colorScheme = Theme.of(context).colorScheme;
